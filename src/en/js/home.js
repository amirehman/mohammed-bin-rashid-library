...
let text2Wrapper = "Vision Mission And Goals";
let res2 = text2Wrapper.split(" ");


res2.forEach(latter => {
    $(".animtedtext2-wrapper").append(`<span class='animtedtext1 inline-block'> ${latter} </span>`);
...
function sectionOneAnimateDelay() {
    ...
    gsap.fromTo(".animtedtext1", 0.6, { opacity: 0, scale: 0.9, x: -15, y: 10 }, { opacity: 1, scale: 0.97, x: 0, y: 0, stagger: 0.07 } )
...
function sectionThreeAnimateEarly() {
    gsap.fromTo(".animtedtext3", 0.6, { opacity: 0, scale: 0.9, x: -15, y: 10 }, { opacity: 1, scale: 0.97, x: 0, y: 0, stagger: 0.07 } )
    gsap.fromTo(".glbox",
        0.7,
        {
            opacity: 0,
...
function sectionFourAnimateEarly() {
    gsap.fromTo(".animtedtext4", 0.6, { opacity: 0, scale: 0.9, x: -15, y: 10 }, { opacity: 1, scale: 0.97, x: 0, y: 0, stagger: 0.07 } )
...
$(document).on('scroll', function() {
    ...
    if ($(this).scrollTop() >= $('.section-two').position().top) {
    ...
    if ($(this).scrollTop() >= $('.section-three').position().top) {
    ...
    if ($(this).scrollTop() >= $('.section-four').position().top) {
